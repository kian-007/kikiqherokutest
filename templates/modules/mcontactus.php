				...
				<span style="color:gray;float:right; position:relative; top:70px; right:250px">تماس با ما  < </span><a href="index.php"	style="text-decoration: none; color: black;float:right; position:relative; top:70px; right:100px">صفحه اصلی  <</a>
					<div id=pcontainer >
						<div id="dimages">
							...
							<p class="mg" style="color:white; position: relative; top:50px">kikicutest_online@<img style="float:right" class="imglogo" src="images\instagram.svg"  /></p>
							<p class="mg" style="color:white; position: relative; top:70px">kikicutest_online@<img style="clear:right; float:right;"class="imglogo" src="images\telegram.svg"  /></p>
