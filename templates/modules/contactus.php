				...
				<span style="color:gray;float:right; position:relative; top:70px; right:250px">تماس با ما  < </span><a href="index.php"	style="text-decoration: none; color: black;float:right; position:relative; top:70px; right:100px">صفحه اصلی  <</a>
					<div id='pcontainer'>
						<div id="dimages">
							...
							<p class="mg" style="color:white; position: relative; top:90px"><a href="https://mail.google.com/mail/u/1/#inbox">kikiq2utest.online@gmail.com</a><img style="clear:right; float:right;" class="imglogo" src="images\email.svg"  /></p>
