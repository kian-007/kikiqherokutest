...
?>
                ...
                <div class="item-holder">
                    <a href="https://kikiq2.herokuapp.com/showimages.php?image=14"> 
                ...
                <?php if($item2): ?>
                <div class="item-holder">
                    <a href="https://kikiq2.herokuapp.com/showimages.php?image=15"> 
                        <img class="item-img" src="<?php echo $img_src; ?>" />
                    </a>
                    <p id = 'showitem'><?php echo $item_title; ?>
                        <br/>
                ...
                <?php if($item3): ?>
                <div class="item-holder">
                    <a href="https://kikiq2.herokuapp.com/showimages.php?image=13"> 
                        <img class="item-img" src="<?php echo $img_src; ?>" />
                    </a>
                    <p id = 'showitem'><?php echo $item_title; ?>
                        <br/>
                ...
                <?php if($item4): ?>
                <div class="item-holder">
                    <a href="https://kikiq2.herokuapp.com/showimages.php?image=16"> 
                        <img class="item-img" src="<?php echo $img_src; ?>" />
                    </a>
                    <p id = 'showitem'><?php echo $item_title; ?>
                        <br/>
                ...
                <?php if($item5): ?>
                <div class="item-holder">
                    <a href="https://kikiq2.herokuapp.com/showimages.php?image=17"> 
                        <img class="item-img" src="<?php echo $img_src; ?>" />
                    </a>
                    <p id = 'showitem'><?php echo $item_title; ?>
                        <br/>
                ...
                <?php if($item6): ?>
                <div class="item-holder">
                    <a href="https://kikiq2.herokuapp.com/showimages.php?image=18"> 
                        <img class="item-img" src="<?php echo $img_src; ?>" />
                    </a>
                    <p id = 'showitem'><?php echo $item_title; ?>
                        <br/>
                ...
                <?php if($item8): ?>
                <div class="item-holder">
                    <a href="https://kikiq2.herokuapp.com/showimages.php?image=12"> 
                        <img class="item-img" src="<?php echo $img_src; ?>" />
                    </a>
                    <p id = 'showitem'><?php echo $item_title; ?>
                        <br/>
                ...
                <?php if($item9): ?>
                <div class="item-holder">
                    <a href="https://kikiq2.herokuapp.com/showimages.php?image=19"> 
                        <img class="item-img" src="<?php echo $img_src; ?>" />
                    </a>
                    <p id = 'showitem'><?php echo $item_title; ?>
                        <br/>
                ...
                <?php if($item10): ?>
                <div class="item-holder">
                    <a href="https://kikiq2.herokuapp.com/showimages.php?image=20"> 
                        <img class="item-img" src="<?php echo $img_src; ?>" />
                    </a>
                    <p id = 'showitem'><?php echo $item_title; ?>
                        <br/>
                ...
                <?php if($item11): ?>
                <div class="item-holder">
                    <a href="https://kikiq2.herokuapp.com/showimages.php?image=21"> 
                        <img class="item-img" src="<?php echo $img_src; ?>" />
                    </a>
                    <p id = 'showitem'><?php echo $item_title; ?>
                        <br/>
