...
?>
                ...
                <div class="item-holder">
                    ...
                    <form  action="<?php home_url('iteminfo.php?item-mirror=1'); ?>" method="post" style="background-color:green; color:white; float:right; clear:both; margin-right: 50px; ">
                        <input  name="buy" id="buy" type="button" value="خرید" style="background-color:green; color:white; float:right;" />
                    <form>
                </div>
                <?php endif; ?>
