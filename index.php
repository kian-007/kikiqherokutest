<html>
	...
	<a name="start"></a>
		<div class="container"> 
			...
			<div class="footer">
				 <p style="position: absolute; top: 500px"><span style="color:red; font-weight: 21pt;">  2021©  کلیه حقوق این سایت محفوظ میباشد</span></p>
				 <b><a  href="contactus.php"	 style="text-decoration: none; float: right;position:relative;top: 500px; right: 50px; color: #222">تماس با ما</a></b>
			</div>
		</div>
	</body>
</html>
